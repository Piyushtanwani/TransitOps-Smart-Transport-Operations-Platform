...
|---|---|---|---|
| DB-01 | Postgres via compose + test DB + git identity | Afif | TODO |
| DB-02 | DB wiring: config, session, base, enums | Afif | TODO |
| DB-03 | Models: users, vehicles, drivers | Afif | TODO |
...
| BE-01 | Backend scaffold: pyproject, app skeleton, health, Makefile | Ismail | TODO |
...
| FE-01 | Vite scaffold + Tailwind tokens + fonts + theme toggle | Piyush | DONE |
